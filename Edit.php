...
class TM_Testimonials_Block_Adminhtml_Customer_Edit extends Mage_Adminhtml_Block_Customer_Edit
{
    public function __construct()
    {
        ...
        if ($this->getCustomerId() &&
			...
			$this->_addButton('Send Email', array(
                'label' => Mage::helper('customer')->__('Send Email'),
                'onclick' => "setLocation('{$this->getUrl('*/testimonials_index/editor')}')",
                'class' => 'mail',
            ), 10);
        }
